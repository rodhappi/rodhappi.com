---
title: "Tiempo sin escribir 2: Lo que estoy explorando."
date: 2026-03-10
...
status: draft
---
![Cuadro de persona escribiendo](../media/thumbnail-sistemas.png)
...
Durante años tuve que elegir entre pensar y construir. La escala me obligó al management. Con IA, ese trade-off desapareció. Soy un creador que piensa — y la IA me devolvió eso. El 80/20 se invirtió. Not anymore.

Creo que emergerán nuevos roles con skills que nadie está enseñando. Lingüística. Matemáticas. Diseño de sistemas. La intersección entre ingeniería, diseño y negocio ya no es el unicornio — ahora todo es el unicornio, y más. Los roles que vendrán no tienen nombre todavía, pero requieren actitudes y habilidades que no se enseñan en ninguna universidad.

Creo que las organizaciones no se están tomando en serio la IA. La están viendo como otra transformación más — como el ERP, como el cloud, como el agile. Hype primero, cuatro años después siguen haciendo lo mismo con otra metodología pero el mismo workflow. No es cinismo. Es patrón.

Y el patrón tiene una causa específica: en Chile — y en gran parte de LatAm — se está haciendo optimización local. El objetivo es ir rápido y con calidad hacia donde veníamos yendo. Nadie está preguntando hacia dónde ir. Crear más rápido no genera ventaja competitiva. Saber qué construir — eso sí. Esa diferencia, entre velocidad de ejecución y claridad de dirección, es el problema real que nadie está resolviendo.

Creo también que la IA nos va a obligar a entender qué significa ser humano. Porque nos forzará a ver nuestro verdadero valor. No lo que hacemos. Lo que somos capaces de ver que las máquinas todavía no pueden ver.

Y creo esto: los sistemas de IA no están ayudando a las personas a hacer su trabajo. Están empezando a hacer el trabajo. El producto ya no es el software — es la tarea completada. Las organizaciones van a dejar de comprar herramientas para gestionar trabajo. Van a comprar sistemas que hacen el trabajo. Y las empresas que construyan esos sistemas van a operar funciones enteras de la economía.

Hace 15 años dije que necesitábamos business intelligence self-service. Nadie me creyó. Llegó Tableau. No me atribuyo mérito. Me atribuyo la lección: la señal estaba ahí. El error es no actuar cuando la ves.

La señal está ahí de nuevo.

---

## Lo que estoy construyendo para saber si tengo razón

**rodhappi.com** — este espacio. Donde escribo sobre la física de la IA: lo que aprendo, lo que rompe, lo que me equivoco. No thought leadership. Reportes de campo.

**alt_FWD** — donde construyo lo que creo. Estoy desarrollando un meta-harness: un sistema que me permite diseñar e implementar gobernanza computable en cualquier dominio. Hoy la gobernanza ocurre en reuniones y roles que deciden sin datos, sin aprendizaje, sin efecto compuesto. Cero compounding. Yo hago esa gobernanza computable. No es un producto. Es un sistema que hace el trabajo. alt_FWD es donde eso se convierte, eventualmente, en servicios que operan solos.

**ProductTank Santiago** — la comunidad que organizo hace años. Sigue siendo relevante. Quizás más que nunca, porque necesitamos espacios donde hablar de lo que realmente está pasando, no del hype.

**Continuum** — la boutique de consultoría que dirijo. Creo que una boutique puede valer cientos de millones de dólares si ve el elefante en el cuadro: la consultoría tradicional va a ser reemplazada por sistemas que hacen el trabajo de consultar. Los que sobrevivan serán los que construyan esos sistemas, no los que vendan metodologías.
