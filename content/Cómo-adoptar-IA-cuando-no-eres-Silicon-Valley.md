---
title: "Cómo Adoptar IA cuando no eres Silicon Valley"
date: 2026-04-01
description: "¿Cómo adoptar IA cuando tu realidad no es la misma que en Silicon Valley tanto en cultura como en tecnología y talento?"
featured: false
thumbnail: media/silicon-valley.jpg
---
![Cuadro de persona escribiendo](../media/silicon-valley.jpg)

Este año en [Pendomonium](https://www.pendo.io/pendomonium/), uno de los eventos de producto más importantes en Estados Unidos, la IA se tomó la agenda y en medio de la conferencia conocí a [Rahul, Cofounder y CPO de Pendo](https://www.linkedin.com/in/rahuljain4/).  
...
¿Su respuesta? Sorprendentemente concreta. Aquí 5 puntos claves para comenzar a adoptar IA en tu organización, más un Bonus si eres banco. 

1. 🦋 La transformación es humana, no tecnológica
2. 🚀 Tres pilares para empezar (sin romper nada)
3. 👩‍💼 El ejecutivo no puede solo mandar "usen IA"
4. 👨‍🎨 Governance: primero libertad, después optimización
5. 🐣 Cómo nació Novus: first principles, no "IA encima de lo viejo"
6. 🏛️ Bonus: La IA para la Banca no es supervivencia, es margen.
...
Pero la persona curiosa dice: 

> "I failed the first time. But then I figured it out."

Entonces, el primer paso no es comprar herramientas. Es identificar a esos curiosos y convertirlos en champions.
...
### Primero 👉 Personas correctas (1/3).
...
### Luego 👉 Tareas pequeñas que nadie quiere hacer (2/3).
No empezar automatizando el proceso completo de aprobación de créditos por ejemplo. Empezar con la tarea que todos odian: revisar cada mañana qué solicitudes nuevas llegaron. Que un agente genere ese reporte. No amenaza el puesto de nadie, y genera una prueba de valor que es difícil de ignorar.
...
### Finalmente 👉 Apps internas pequeñas (3/3).
Antes de construir productos nuevos con IA, tomar una aplicación interna vieja que usan pocas personas y reconstruirla. Si quieres continuar avanzando, comienza a buscar esos aplicativos o legados que te generan varios dolores, y nadie quiere invertir un peso en ellos. Analiza y valida dónde puedes generar un mejora controlada.  El objetivo no es la app en si mismo, es que el equipo aprenda a construir con IA en un entorno de bajo riesgo.

---

## Los ejecutivos no pueden sólo decir "usen IA"

> *"If the executive just tells somebody to go do AI, they don't know what that means. It's too broad."*

Cada CEO en el mundo está sintiendo la presión. Ven en X o Linkedin que todas las empresas se están transformando o ya se transformaron. Hay mucho hype, pero también resultados concretos como que Stripe está liberando 1.300 PR a la semana. La presión existe y genera un ciclo donde los líderes y ejecutivos mandan un artículo a su equipo, el equipo no sabe por dónde empezar, nadie avanza, y la ansiedad crece.

La solución que Rahul describe es concreta. Los líderes deben identificar tres proyectos específicos con hitos claros. No "implementen IA en la operación". Sino, "este proceso de gestión de gastos ¿podemos hacer que un agente lo simplifique? ¿Podemos ver algo este viernes?"

En Pendo han tomado este enfoque, donde el lunes definen el proyecto, viernes muestran resultado. Ciclos semanales que generan evidencia y reducen la parálisis.
...
## First Principle: No aplicar "IA encima de lo viejo". Cómo nació Novus.

En Pendonomium uno de los momentos más esperados fue Novus, el agente autónomo que se conecta directamente al codebase, auto-tagea features, detecta problemas de UX y genera pull requests. Cuando la conversación giró hacia cómo Pendo construyó Novus, Rahul reveló algo que aplica mucho más allá de Pendo:
